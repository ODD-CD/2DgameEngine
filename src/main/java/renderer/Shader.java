...
public class Shader {
    ...
    public Shader(String filepath) {
        ...
        try {
            ...
            // Identify vertex or fragment source
    ...
    public void compileAndLink() {
        ...
        // Pass source for vertex shader created
        glShaderSource(vertexID, vertexSource);
        // Compile vertex shader with source
        ...
        // Pass source for fragment shader created
        glShaderSource(fragmentID, fragmentSource);
        // Compile fragment shader with source
